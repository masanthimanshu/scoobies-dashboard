...
export const ReturnAnalysis: React.FC<ReturnAnalysisProps> = React.memo(
  ({ records, products, channels, metrics }) => {
    ...
    const channelScopedReturnedProducts = useMemo(() => {
      // Fast path: when All Channels is selected, use pre-calculated productMetrics
      ...
      if (records && records.length > 0) {
        ...
        for (let i = 0; i < rLen; i++) {
          ...
          if (channelName.toLowerCase() !== targetChannelLower) {
            continue;
          }
      ...
      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#8C8376] font-medium mt-0.5">
                Comprehensive breakdown of returns across marketplace channels
        ...
        <div className="bg-[#FAF8F5] border border-[#EBE5D9] rounded-2xl p-4 sm:p-5">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              >
                <option value="ALL">
                  All Channels ({formatNumber(metrics?.totalReturnedUnits)}{" "}
                  total units)
                </option>
                {channelsWithReturns.map((ch) => (
        ...
        <div className="mt-4 p-3.5 rounded-2xl bg-[#FAF0E6] border border-[#E8D2C2] text-xs text-[#433E37] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="text-[11px] font-bold text-[#AF8260] shrink-0">
            Recommendation: Verify packaging & product descriptions on
            high-return SKUs
          </div>
        </div>
      </section>
