      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-18 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2.5">
            {/* Target Progress Quick Widget - Single Line */}
            <div 
              onClick={onOpenGoal}
              className="hidden md:flex items-center gap-2.5 px-3.5 py-2 rounded-2xl border border-[#EBE5D9] bg-[#FAF8F5] hover:bg-[#F1EDE5] cursor-pointer transition-colors"
              title="Click to adjust sales target quota"
            >
              <div className="w-7 h-7 rounded-full bg-[#FAF0E6] flex items-center justify-center text-[#AF8260] shrink-0">
                <Target className="w-4 h-4" />
              </div>
              <div className="text-left">
                <div className="flex items-center justify-between gap-3 text-xs">
                  <span className="font-bold text-[#2D2A26] whitespace-nowrap">
                    Target: ₹{salesTarget.toLocaleString()}
                  </span>
                  <span className="font-extrabold text-[#AF8260] text-xs">
                    {targetPct}%
                  </span>
                </div>
                <div className="w-32 h-1.5 bg-[#EBE5D9] rounded-full mt-1 overflow-hidden">
                  <div 
